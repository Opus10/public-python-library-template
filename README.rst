...
A new public python package can be started with::
    ...
    footing setup git@github.com:Opus10/public-python-library-template.git
...
``footing ls github.com/Opus10 git@github.com:Opus10/public-python-library-template.git`` to see a list of
